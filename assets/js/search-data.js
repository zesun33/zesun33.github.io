...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-introduction-to-neuromorphic-computing-the-future-of-brain-inspired-ai",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2025/neuromorphic-computing-introduction/";
          
        },
      },{id: "post-building-an-academic-website-a-phd-student-39-s-guide-to-online-presence",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2025/academic-seo-guide/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/zesun33", "_blank");
        },
      },{
        id: 'social-university_profile',
        title: 'University_profile',
        section: 'Socials',
        handler: () => {
          window.open("", "_blank");
        },
