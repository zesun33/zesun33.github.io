...
ninja.data = [{
    ...
    section: "Navigation",
    handler: () => {
      window.location.href = "/zesunahmed.github.io/";
    },
  },{id: "nav-blog",
          title: "Blog",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/zesunahmed.github.io/blog/";
          },
        },{id: "nav-publications",
          title: "Publications",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/zesunahmed.github.io/publications/";
          },
        },{id: "nav-projects",
          title: "Projects",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/zesunahmed.github.io/projects/";
          },
        },{id: "nav-repositories",
          title: "Repositories",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/zesunahmed.github.io/repositories/";
          },
        },{id: "nav-cv",
          title: "CV",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/zesunahmed.github.io/cv/";
          },
        },{id: "nav-teaching",
          title: "Teaching",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/zesunahmed.github.io/teaching/";
          },
        ...
        handler: () => {
            ...
            window.location.href = "/zesunahmed.github.io/blog/2025/phd-journey-neuromorphic-computing/";
        ...
        handler: () => {
            ...
            window.location.href = "/zesunahmed.github.io/blog/2025/intel-internship-experience/";
          ...
          section: "Books",handler: () => {
              window.location.href = "/zesunahmed.github.io/books/the_godfather/";
          ...
          section: "News",handler: () => {
              window.location.href = "/zesunahmed.github.io/news/2024-12-18-icece-conference-presentation/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/astromorphic-transformers/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/dcnn-lstm-audio-classification/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/electronic-braille-device/";
            },},{id: "projects-future-research-directions",
          title: 'Future Research Directions',
          description: "Upcoming research initiatives and collaborative opportunities",
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/future-research-directions/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/gan-nanoribbons-thermal/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/irfd-electricity-fraud-detection/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zesunahmed.github.io/projects/neuromorphic-hydrogen-gradients/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/zesunahmed.github.io/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
